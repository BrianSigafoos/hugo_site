...
> Thoroughly review the plan and code. Find bugs, suggest improvements, and make sure the code is correct and maintainable. The code should be as simple as possible and not overly engineered. 
